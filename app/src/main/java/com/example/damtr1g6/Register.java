...
public class Register extends AppCompatActivity {
    ...
    public void launchPaginaPrincipal(View view){
        ...
        if (texto.isEmpty() || texto2.isEmpty() || texto3.isEmpty() || texto4.isEmpty()){
            ...
            if (texto2.isEmpty()) {
                correu.setError("Campo obligatorio");
            }
            if (texto3.isEmpty()) {
                contra.setError("Campo obligatorio");
            }
            if (texto4.isEmpty()){
                rol.setError("Campo obligatorio");
            }
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://192.168.205.153:3672/usuario/")
            ...
            Log.d("Añade", "User añadido");
            call.enqueue(new Callback<Usuarios>() {
                @Override
                public void onResponse(Call<Usuarios> call, Response<Usuarios> response) {
                    Log.d("Response", "repon");
                    if (response.isSuccessful()) {
                        ...
                        Log.d("NO añade", "User no añadido");
                    }
                }
